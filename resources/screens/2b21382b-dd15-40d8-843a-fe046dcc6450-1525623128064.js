jQuery("#simulation")
  .on("click", ".s-2b21382b-dd15-40d8-843a-fe046dcc6450 .click", function(event, data) {
  ...
  .on("keydown.jim", ".s-2b21382b-dd15-40d8-843a-fe046dcc6450 .keydown", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusin", ".s-2b21382b-dd15-40d8-843a-fe046dcc6450 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-2b21382b-dd15-40d8-843a-fe046dcc6450 #s-Input_usuario": {
                      "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-2b21382b-dd15-40d8-843a-fe046dcc6450 #s-Input_contrasenia": {
                      "attributes": {
                        "border-top-width": "1px",
                        "border-top-style": "solid",
                        "border-top-color": "#0088CC",
                    ...
                    "#s-2b21382b-dd15-40d8-843a-fe046dcc6450 #s-Input_contrasenia INPUT": {
                      "attributes-ie8lte": {
                        "font-family": "Arial"
                      }
                    }
  ...
  .on("focusout", ".s-2b21382b-dd15-40d8-843a-fe046dcc6450 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("mouseenter dragenter", ".s-2b21382b-dd15-40d8-843a-fe046dcc6450 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-2b21382b-dd15-40d8-843a-fe046dcc6450 #s-Boton_sign_in": {
                      "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-2b21382b-dd15-40d8-843a-fe046dcc6450 #s-Boton_login": {
                      "attributes": {
  ...
  .on("mouseleave dragleave", ".s-2b21382b-dd15-40d8-843a-fe046dcc6450 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
