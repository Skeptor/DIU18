jQuery("#simulation")
  .on("click", ".s-8c97bda1-22c9-488a-904e-56c3e312af2e .click", function(event, data) {
    ...
    if(jFirer.is("#s-Boton_sign_in")) {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-Talleres_1")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-Conferencias_exposiciones_1")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-Contactanos_1")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-Acerca_de_1")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/d5565209-964b-4364-a964-07770e2a0bf7"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("keydown.jim", ".s-8c97bda1-22c9-488a-904e-56c3e312af2e .keydown", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusin", ".s-8c97bda1-22c9-488a-904e-56c3e312af2e .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-8c97bda1-22c9-488a-904e-56c3e312af2e #s-Input_usuario": {
                      "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-8c97bda1-22c9-488a-904e-56c3e312af2e #s-Input_contrasenia": {
                      "attributes": {
                        "border-top-width": "1px",
                        "border-top-style": "solid",
                        "border-top-color": "#0088CC",
                    ...
                    "#s-8c97bda1-22c9-488a-904e-56c3e312af2e #s-Input_contrasenia INPUT": {
                      "attributes-ie8lte": {
                        "font-family": "Arial"
                      }
                    }
  ...
  .on("focusout", ".s-8c97bda1-22c9-488a-904e-56c3e312af2e .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("mouseenter dragenter", ".s-8c97bda1-22c9-488a-904e-56c3e312af2e .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-8c97bda1-22c9-488a-904e-56c3e312af2e #s-Boton_sign_in": {
                      "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-8c97bda1-22c9-488a-904e-56c3e312af2e #s-Boton_login": {
                      "attributes": {
  ...
  .on("mouseleave dragleave", ".s-8c97bda1-22c9-488a-904e-56c3e312af2e .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
