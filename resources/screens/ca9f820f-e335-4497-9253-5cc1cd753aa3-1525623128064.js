jQuery("#simulation")
  .on("click", ".s-ca9f820f-e335-4497-9253-5cc1cd753aa3 .click", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Facebook")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-Boton_sign_in")) {
      cases = [
        {
          "blocks": [
            {
  ...
  .on("keydown.jim", ".s-ca9f820f-e335-4497-9253-5cc1cd753aa3 .keydown", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusin", ".s-ca9f820f-e335-4497-9253-5cc1cd753aa3 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-ca9f820f-e335-4497-9253-5cc1cd753aa3 #s-Input_usuario": {
                      "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-ca9f820f-e335-4497-9253-5cc1cd753aa3 #s-Input_contrasenia": {
                      "attributes": {
                        "border-top-width": "1px",
                        "border-top-style": "solid",
                        "border-top-color": "#0088CC",
                    ...
                    "#s-ca9f820f-e335-4497-9253-5cc1cd753aa3 #s-Input_contrasenia INPUT": {
                      "attributes-ie8lte": {
                        "font-family": "Arial"
                      }
                    }
  ...
  .on("focusout", ".s-ca9f820f-e335-4497-9253-5cc1cd753aa3 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("mouseenter dragenter", ".s-ca9f820f-e335-4497-9253-5cc1cd753aa3 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-ca9f820f-e335-4497-9253-5cc1cd753aa3 #s-Boton_sign_in": {
                      "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-ca9f820f-e335-4497-9253-5cc1cd753aa3 #s-Boton_login": {
                      "attributes": {
  ...
  .on("mouseleave dragleave", ".s-ca9f820f-e335-4497-9253-5cc1cd753aa3 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
